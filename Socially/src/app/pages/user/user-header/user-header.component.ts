...
export class UserHeaderComponent implements OnInit {
  ...
  async deleteAccount() {
    ...
    if (consent.isConfirmed) {
      this.apiService
        .delete(
          apiConstant.API_HOST_URL + apiConstant.DELETE_ACCOUNT + this.user._id,
        )
        .subscribe({
          next: (res: any) => {
  ...
  postIt() {
    ...
    this.apiService
      .post(
        apiConstant.API_HOST_URL + apiConstant.POST + this.user._id,
        formData,
      )
      .subscribe({
        next: (res: any) => {
  ...
  availableUsers() {
    this.apiService
      .get(apiConstant.API_HOST_URL + apiConstant.SEARCHLIST_USERS)
      .subscribe({
  ...
  onSearch() {
    ...
    this.filteredUsers = this.searchedUsers?.filter((user) =>
  ...
  seeUser(username: string) {
    ...
    this.router.navigate(["seeProfile"], {
      queryParams: { username: username, profile: this.user.username },
    });
  }
